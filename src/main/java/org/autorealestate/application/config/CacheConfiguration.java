package org.autorealestate.application.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("autorealestate");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("autorealestate");
        ...
        config.getMapConfigs().put("org.autorealestate.application.domain.*", initializeDomainMapConfig(jHipsterProperties));
