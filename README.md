[![Build Status](https://travis-ci.org/autorealestate/autorealestate.svg?branch=master)](https://travis-ci.org/autorealestate/autorealestate)
...
To optimize the autorealestate application for production, run:
